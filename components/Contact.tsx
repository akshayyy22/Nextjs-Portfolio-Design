...
export default function MeteorsDemo() {
  ...
  const handleCopy = () => {
    const text = "akshaypersonaluserid@gmail.com";
  ...
  const handleDownloadResume = () => {
    ...
    link.href = resumeUrl;
    link.setAttribute("download", "Akshay_Resume.pdf"); // Specify the file name
  ...
  return (
    <div className="py-40 w-full mb-20">
      <h1 className="heading">
        Wanna <span className="text-purple">Hire Me?</span>
      </h1>
